      ...
      <div class="container">
        <div class="row">          
          <div class="col-md-9 bg-white padding-2">
            ...
            <div><i class="fa fa fa-inr text-green"></i>&nbsp&nbspSalary Range:
              <?php echo stripcslashes($row['minimumsalary']); ?>
              -
              <?php echo stripcslashes($row['maximumsalary']); ?>
            </div>
            <div><i class="fa fa-graduation-cap text-green"></i>&nbspQualification :
              <?php echo stripcslashes($row['qualification']); ?>
            </div>
            <div><i class="fa fa-hourglass-end text-green"></i>&nbsp&nbsp&nbsp&nbspExperience :
              <?php echo stripcslashes($row['experience']); ?>
            </div>
            <div><p>
              <?php echo stripcslashes($row['description']); ?></p>
            </div>
            <?php 
          ...
          <div class="col-md-3">
            <div class="thumbnail">
              ...
              <div class="caption text-center">
                ...
                <p><a href="test.php?id=<?php echo $row['id_jobpost']; ?>" class="btn btn-primary btn-flat" role="button">More Info</a>
                <hr>
                <div class="row">
                <?php 
            if(isset($_SESSION["id_user"]) && empty($_SESSION['companyLogged'])) { ?>
                  ...
                  <div class="col-md-4"><a href="login-candidates.php"><i class="fa fa-envelope"></i> Email</a></div>
                </div>
              </div>
            </div>
          </div>
