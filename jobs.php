                ...
                <ul class="nav nav-pills nav-stacked tree" data-widget="tree">
                  <li class="treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                      ...
                      <li><a href="" class="citySearch" data-target="Kolkalta"><i class="fa fa-circle-o text-yellow"></i> Kolkalta</a></li>
                      ...
                      <li><a href="" class="citySearch" data-target="TVM"><i class="fa fa-circle-o text-yellow"></i> TVM</a></li>
                    </ul>
                  </li>
                  <li class="treeview menu-open">
